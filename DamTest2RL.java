 ...
 *               To do this, just append provided "stub" code interfaces into your Dam class, at end but before main().
 ...
 *         
 *               1) Append placeholder methods for ALL 10 *added* API methods (see above)
 *               2) Change DamAO --> DamFL, by doing global find-replace (Ctrl-F)
 *               3) Change UtilsAO --> UtilsFL, by doing global find-replace (Ctrl-F)
...
public class DamTest2RL {
    ...
    final static CS12Date TODAY = UtilsAO.today();
    final static CS12Date MEAS_DATE = new CS12Date(4, 22, 2020);  // TODO: measurement date
    ...
    public static void main(String [] args) {
        ...
        do  {
            ...
            // priming read
            option = UtilsAO.readChar(menu, false);
    ...
    private static void runDamDisplayFormatTest() {
        DamAO test = new DamAO("test dam", 1900, 
    ...
    private static void runDamDerivedDataTests() {
        ...
        DamAO test = new DamAO("starting dam", TEST_YEAR,
        ...
        // added test to expose a divide by zero error on default dam
        test = new DamAO();
        test.print("test dam default values, should see 0 for storage/capacity, and 0.0 (not NaN) for pct full");
        pause();
    ...
    private static void runDamNumericTests() {
        DamAO folsom, oroville, shasta, nimbus;
        ...
        folsom   = new DamAO("Folsom",   1956,  647357,  977000, 4306, 1622, MEAS_DATE);
        oroville = new DamAO("Oroville", 1968, 2451713, 3537577, 5088, 2376, MEAS_DATE);
        shasta   = new DamAO("Shasta",   1945, 3747651, 4552000, 4779, 5859, MEAS_DATE);
        nimbus   = new DamAO("Nimbus",   1955,    7885,    9000, 1428, 1471, MEAS_DATE);
    ...
    private static void runDamHoldingTest() {
        ...
        DamAO test = new DamAO("holding dam", TEST_YEAR, 
    ...
    private static void runDamWaterUtilsNominalTests() {
        ...
        // starting dam state
        test = new DamAO("test dam", TEST_YEAR, TEST_STORAGE, TEST_CAPACITY, TEST_INFLOW, TEST_OUTFLOW, MEAS_DATE);
    ...
    private static void runDamMutatorDataCheckingTests() {
        ...
        DamAO test = new DamAO("test dam", TEST_YEAR, TEST_STORAGE, TEST_CAPACITY, TEST_INFLOW, TEST_OUTFLOW, MEAS_DATE);
    ...
    private static void runDamConstructorsBadDataTests() {
        ...
        blank();
        test = new DamAO("Bad Dam", 1899, -100000, -200000, -1000, -2000, new CS12Date());
        ...
        test = new DamAO("Bad Dam", -500000.0);
    ...
    private static void runDamWaterUtilsBadDataTests() {
        ...
        test = test = new DamAO("test dam", TEST_YEAR, 0.0, TEST_CAPACITY, TEST_INFLOW, TEST_OUTFLOW, MEAS_DATE);
