 ...
 *                or: Ctrl-F
 *                change UtilsAO ==> your Utils class name
...
public class UtilsTest1RL {
    ...
    public static void main(String [] args) {
        ...
        if (doAgeTests) {
            ...
            // M3-M4: Bill Gates 65th
            bd.setDate(10, 28, 1955);
            ref.setDate(10, 28, 2020);
            runTest2("M3", bd, ref, 65, "Bill Gates 65th");
            ref.setDate(10, 27, 2020);
            runTest2("M4", bd, ref, 64, "Bill Gates 65th, day before");    
    ...
    private static int getFutureMonth(boolean isSpring) {
        ...
        if (isSpring) {
            ...
            month = rand.nextInt(2) + 11;  // Nov-Dec only
            month = 12;                    // Dec only, Nov not a future month if early Nov!
        }
